      ...
      <div className="hidden md:block">
        <div className='tabs-container xl:w-[70vw] lg:w-[85vw] md:w-[85vw] sm:w-[85vw] w-[85vw]'>
          ...
          <div className="content">
            <div className="overflow-y-auto scrollbar-thumb-rounded-full scrollbar-track-rounded-full scrollbar scrollbar-thumb-preto scrollbar-track-verde h-[70vh]">
              {Data.map((data, i) => (
                <div
                  className={`desc xl:p-12 lg:p-12 sm:p-12 md:p-12 xs:p-5 ${activeTab === i ? 'active' : ''}`}
                  key={i}
                >
                  {data.desc}
                </div>
