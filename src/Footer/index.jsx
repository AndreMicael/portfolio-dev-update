...
const Footer = () => {
  return (
    <footer className="bg-preto w-full p-4 mt-16 overflow-hidden">
        <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
            ...
            <div className="text-center">
                <span className="text-sm sm:text-base">
                    © 2024 <a href="/" className="text-[#23CE99] hover:underline">André Micael Sampaio</a>. Todos os direitos Reservados.
                </span>
            </div>
        </div>
    </footer>
